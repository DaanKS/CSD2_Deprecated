...
int main(int argc,char **argv)
{
  ...
  jack.onProcess = [&circBuffer, &sine1](jack_default_audio_sample_t *inBuf,
    ...
    for(unsigned int i = 0; i < nframes; i++) {
      ...
      //Delay Modulation
      circBuffer.setDistanceRW((sine1.getSample() * 1.0) * 100 + 5);
      sine1.tick();
      //TODO - change into unipolar sawtooth. Refine parameters - look into mstosamps. 
    }
    return 0;
  };
